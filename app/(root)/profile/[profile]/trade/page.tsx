                        ...
                        >
                            ...
                            <div className="flex justify-between items-center w-[110%] sm:w-[90%] pb-2">
                                ...
                                <div className="flex items-center space-x-1">
                                    <button className="px-6 sm:px-8 py-0.5 border hover:border-transparent hover:bg-[#2e86fe] border-[#768496] rounded-full bg-transparent flex items-center justify-center text-black transition-colors duration-300 text-sm cursor-pointer">
                                        Sell
                                    </button>
