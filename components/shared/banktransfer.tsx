...
function Banktransfer() {
    ...
    return (
        <>
            {loading && (
                <Loader loaderText="Sending details..." />
            )}
            <div className='flex flex-col gap-y-4  px-3 w-full relative'>
                ...
                <div className='pb-22 flex flex-col gap-y-4 items-start text-zinc-500 text-[13px]'>
                    ...
                    <p>
                        The transfer must be made from an account in your name {user?.name} .
                    </p>
                    <p>
                        Funds should be updated in your account within 5 business days. Make sure to provide the reference number (2646532348) to avoid delays.
                    </p>
                    <p>
                ...
                <div className='fixed bottom-0 z-50 left-0 pt-4 bg-white   pb-4 shadow-none w-full flex flex-col items-center justify-center gap-2'>
                    ...
                    <button onClick={handleSend} className=" sm:w-72 w-52 mt-2  py-2 cursor-pointer bg-[linear-gradient(90deg,#11afff_2%,#2e86fe_33%)] duration-300 border-none ease-in-out rounded-sm  overflow-hidden text-white  flex items-center justify-center font-normal text-[15px]">
                        Send me
                    </button>
